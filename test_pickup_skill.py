...
def get_skill_config(skills=['reach']):
    ...
    config_dict = {
            ...
            "reach_config": {
                "global_xyz_bounds": [[-0.10, -0.30, 0.80], [0.20, 0.30, 0.85]],
                "aff_threshold": [0.15, 0.25, 0.03],
...
def main():
    ...
    # action shape is (action_dim + skill_params,)
    for obj in ['butter_1', 'milk_1', 'tomato_sauce_1']:
        env.reset()
